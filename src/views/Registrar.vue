...
<template>
  <div class="container" v-if="exibirRegistro">
    <div class="container" v-if="abertoInscricao">
    ...
    <div class="container" v-else>
      <div class="row">
        <div class="col-4">
          <img :src="`${publicPath}aguardando.png`" width="300px" height="300px">
        </div>
      </div>
      <div class="row">
        &nbsp;
    ...
    <div class="container">
      ...
      <div class="row">
          <div class="col-8 offset-md-2">
              <router-link to="/gerarnumeros">Gerar Números</router-link>
          </div>
      </div>
      <div class="row">
          <div class="col-8 offset-md-2">
              <router-link to="/registrarcartoes">Registrar Cartões</router-link>
          </div>
      </div>
      <div class="row">
          <div class="col-8 offset-md-2">
